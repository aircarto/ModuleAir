 ...
 * SDA/SCL : Sonde CO2
 * 
 * !! Attention ne pas oulier de modifier le nom du capteur !!!
 * 
...
void loop()
{
  ...
  */
  ...
  //String json = "{\"id_moduleAir\":\"moduleAir1\",\"co2\":" + mySensor.ppm +", \"pm10\":"+ P10 +",\"pm25\":"+ P25 +"}";
  
  String json = "{\"id_moduleAir\":\"moduleAir1\",\"co2\":";
  json.concat(mySensor.ppm);
  json.concat(",\"pm10\":");
  json.concat(P10);
  json.concat(",\"pm25\":");
  json.concat(P25);
